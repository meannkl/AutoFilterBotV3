    ...
    if usr_cmdall1.startswith("/start pr0fess0r_99"):
        if AUTH_CHANNEL:
            ...
            try:
                ...
                await bot.send_message(
                    chat_id=message.from_user.id,
                    text="**Please Join mallu movie Updates Channel to use this Bot!**",
        ...
        try:
            ...
            for files in filedetails:
                ...
                buttons = [
                    [
                        InlineKeyboardButton('🎖Join channel🎖', url=f'{https://t.me/mallmovieup}')
                    ]
                    ]
...
async def bot_info(bot, message):
    buttons = [
        [
            ...
            InlineKeyboardButton('channel', url=f'{https://t.me/mallmovieup}')
        ]
        ]
